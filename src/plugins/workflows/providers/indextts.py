...
class IndexTTSProvider(Provider):
    ...
    def __init__(self, parent):  # , api_id):
        ...
        # self.client = IndexTTS2(cfg_path="checkpoints/config.yaml", model_dir="checkpoints", use_fp16=False, use_cuda_kernel=False, use_deepspeed=False)
    ...
    def get_model_stream(self, model_obj, **kwargs):
        ...
        self.client.infer(spk_audio_prompt='/home/jb/CursorProjects/AgentPilot/audio/Click_this_plus.wav', text=text, output_path="gen.wav", verbose=True)

        # return generator of the audio
        with open("gen.wav", "rb") as f:
            return f.read()
