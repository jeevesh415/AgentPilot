"""Video Model Member Module.

This module provides the VideoModel member, a specialized model for processing
and generating videos within workflows. Video models enable AI-powered video
generation, analysis, and manipulation capabilities integrated with the
Agent Pilot ecosystem.

Key Features:
- AI-powered video generation and processing
- Integration with video generation APIs and models
...
- Support for various video AI model providers
- Output handling for generated videos

Video models expand workflow capabilities to include visual content
...
@set_module_type(module_type='Members', plugin='MODEL', settings='video_model_settings')
class VideoModel(Model):
    default_role = 'video'
    default_avatar = ':/resources/icon-video.png'
    default_name = 'Video Model'
